...
class UserToken(models.Model):
    ...
    remaining_time = models.BigIntegerField(editable=False, blank=True, default=1800)

    def save(self, *args, **kwargs):
        self.remaining_time = self.expires_in - (timezone.now() - self.created_at).total_seconds()
